...
public class InteracETransferForm extends PaymentMethodForm {
    ...
    public static int addFormForBuyer(GridPane gridPane, int gridRow, PaymentAccountContractData paymentAccountContractData) {
        ...
        addLabelTextField(gridPane, ++gridRow, "Email or phone number:", ((InteracETransferAccountContractData) paymentAccountContractData).getEmail());
    ...
    public void addFormForAddAccount() {
        ...
        mobileNrInputTextField = addLabelInputTextField(gridPane, ++gridRow, "Email or phone number:").second;
